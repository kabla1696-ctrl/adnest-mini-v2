...
var ADS = [
{ cat: "crypto", title: "Sponsored: Hardware Wallet", body: "Secure assets offline.", cta: "Explore", url: "https://example.com/crypto-1" },
{ cat: "tech", title: "Sponsored: VPS for Builders", body: "Deploy faster with simple pricing.", cta: "See plans", url: "https://example.com/tech-1" },
{ cat: "finance", title: "Sponsored: Expense Tracker", body: "Control spending smartly.", cta: "Open", url: "https://example.com/fin-1" }
];
var idx = 0;
var timer = null;
...
renderNextAd();
timer = setInterval(renderNextAd, 10000); // 10 sec
window.__ADNEST_TIMER__ = timer;
} catch (e) {
// swallow to avoid page break
}
})();
